...
# Изменить атрибут circle = 1

# Посредством обращения через имя объекта вызвать список атрибутов объекта a (убедиться, что он пустой и что изменение
# атрибутов класса не влияет на атрибуты объекта т.к. они в разных пространствах имён).

# Посредством обращения через имя объекта вызвать список атрибутов объекта b (убедиться, что он пустой и что изменение
# атрибутов класса не влияет на атрибуты объекта т.к. они в разных пространствах имён).
