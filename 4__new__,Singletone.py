...
# первого параметр обязательного параметра ссылку на сам класс - cls.
class Point:
...
# метод new должен возвращать ссылку не объект, котору при этом он берёт из базового класса, стоящего
